...
class ExpansionsControllerTest < ActionController::TestCase
  ...
  test "should create expansion" do
    assert_difference('Expansion.count') do
      post :create, expansion: { icon_url: @expansion.icon_url, name: @expansion.name, release_date: @expansion.release_date }
    end
  ...
  test "should update expansion" do
    put :update, id: @expansion, expansion: { icon_url: @expansion.icon_url, name: @expansion.name, release_date: @expansion.release_date }
    assert_redirected_to expansion_path(assigns(:expansion))
  end
